...
const (
	...
	// DockerAPIVersion is version of Docker client API that Metro use.
	DockerAPIVersion = "1.39"

	// DefaultMongoVersion is the default version of the mongodb that Metro use.
	DefaultMongoVersion = "4.0"

	// DefaultMongoHost is the default host name for the mongodb that Metro use.
	DefaultMongoHost = "127.0.0.1"

	// DefaultMongoPort is the default port for the mongodb that Metro use.
